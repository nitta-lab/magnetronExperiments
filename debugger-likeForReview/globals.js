...
var titleToJson = new Map([[title[0], "../artificialPrograms/pre_Exp7/pre_Exp7.json"],
                           ...
                           [title[2],
                            "../realProgramsForReview/ArgoUML/modeSelect/modeSelect.json"],
                           [title[3],
...
//                           [title[1],
//                            "../realProgramsForReview/ArgoUML/actionRemoveFromDiagram/actionRemoveFromDiagram.json.js"],
//                           [title[2],
//                            "../realProgramsForReview/ArgoUML/modeSelect/modeSelect.json"],
//                           [title[3],
//                            "../realProgramsForReview/JHotDraw/defaultDragTracker/defaultDragTracker.json"],
...
//        'src': titleToJson.get(key)
//    });
//    $script.on('load', function(){
//        var data = window.ACTION_REMOVE_FROM_DIAGRAM;
//        root = data.root;
//        init_globals();
//        parent.toolBarFrame.onStartSrcCode(); // srcCode.js
//    });
